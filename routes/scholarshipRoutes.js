...
const { specificDocumentUpload, singleDocumentUpload } = require('../services/uploadScholarship');
...
router.delete('/:id/documents/:documentType/:documentId', scholarshipController.deleteDocument);
...
// Statistics routes
router.get('/statistics/overview', scholarshipController.getSystemStatistics);
router.get('/dashboard/statistics', scholarshipController.getDashboardStatistics);
