...
router.put("/bookings/:id", AdmissionController.updateRecord);
router.delete("/bookings/:id", AdmissionController.deleteRecord);
router.post("/bookings/reminders/send", AdmissionController.sendBookingReminders);
...
router.delete("/universities/:id", AdmissionController.deleteRecord);
...
router.delete("/applications/:id", AdmissionController.deleteRecord);

// ====================
// STATISTICS & ANALYTICS
// ====================
router.get("/statistics/:recordType", AdmissionController.getStatistics);
router.get("/statistics/dashboard/overview", AdmissionController.getDashboardStatistics);
router.get("/analytics/:type", AdmissionController.getAnalytics);
