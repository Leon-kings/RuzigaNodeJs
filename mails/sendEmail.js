...
class EmailService {
  constructor() {
    ...
    this.transporter = nodemailer.createTransport({
      ...
      auth: {
        user: process.env.EMAIL_USER || process.env.SMTP_USER || process.env.EMAIL_USER,
        pass: process.env.EMAIL_PASSWORD || process.env.SMTP_PASS || process.env.EMAIL_PASS,
      },
    });
    ...
    this.adminUrl = process.env.ADMIN_URL || "http://localhost:3000/admin";
  }
