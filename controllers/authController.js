...
//   // Clean the SMTP password - remove any spaces
...
//     const mailOptions = {
//       from: `"${process.env.COMPANY_NAME || 'Rec Apply'}" <${process.env.EMAIL_FROM || process.env.SMTP_USER}>`,
//       to,
//       subject,
//       html
//     };
...
// // Helper function to send system down notification (only to admin)
// const sendSystemDownNotification = async (email, name) => {
//   incrementCounter('email', 'total', null, 1);
//   incrementCounter('email', 'byType', 'systemAlert', 1);
...
//     // Only send to admin, not to user
//     await sendEmail({
//       to: process.env.ADMIN_EMAIL || 'admin@example.com',
//       subject: '⚠️ Email Service Down - Registration Blocked',
//       html: `
...
//       <div class="container">
//         <div class="header">
//           <h1>🎉 Welcome to ${process.env.COMPANY_NAME || 'Rec Apply'}!</h1>
//           <p>Your journey to success begins here</p>
//         </div>
//         <div class="content">
//           <div class="welcome-message">
//             <h2>Hello ${name}! 👋</h2>
//             <p>We're absolutely thrilled to have you on board! Thank you for choosing ${process.env.COMPANY_NAME || 'Rec Apply'} as your partner in success. Your account has been successfully verified and you're now ready to explore all the amazing features we have to offer.</p>
//           </div>
...
//               <div class="feature-desc">Lightning quick applications</div>
//             </div>
//             <div class="feature-item">
//               <div class="feature-icon">🔒</div>
...
//               <div class="feature-desc">Endless opportunities</div>
//             </div>
//             <div class="feature-item">
//               <div class="feature-icon">🌟</div>
//               <div class="feature-title">Premium Support</div>
//               <div class="feature-desc">24/7 dedicated team</div>
//             </div>
//           </div>
...
//             <p>© ${new Date().getFullYear()} ${process.env.COMPANY_NAME || 'Rec Apply'}. All rights reserved.</p>
//             <p>If you have any questions, feel free to contact us at support@recapply.com</p>
//           </div>
//         </div>
//       </div>
//     </body>
...
//             <h2>Hello ${name}! ✨</h2>
//             <p>You're just one click away from unlocking all the amazing features of ${process.env.COMPANY_NAME || 'Rec Apply'}.</p>
//           </div>
          
//           <div class="verification-box">
//             <p style="font-size: 20px; margin-bottom: 20px;">Click the button below to verify your email address:</p>
//             <a href="${verificationUrl}" class="verify-button">✅ Verify Email Address</a>
//           </div>
          
//           <div class="timer-info">
//             <div class="timer-icon">⏰</div>
//             <h3 style="color: #764ba2; margin-bottom: 10px;">Link Expires in 24 Hours</h3>
//             <p style="color: #666;">For your security, this verification link will expire in 24 hours. If you don't verify within this time, you can request a new verification email.</p>
//           </div>
          
//           <p style="text-align: center; color: #888; margin: 20px 0;">Or copy and paste this link in your browser:</p>
//           <div class="link-box">${verificationUrl}</div>
          
//           <div style="text-align: center; margin-top: 30px; padding: 20px; background: #f8f9fa; border-radius: 10px;">
//             <p style="color: #666; font-style: italic;">"Verification is the key that unlocks the door to endless possibilities."</p>
//           </div>
          
//           <p style="text-align: center; color: #888; margin-top: 30px;">
//             If you didn't create an account with us, please ignore this email or contact support.
//           </p>
//         </div>
...
//             Need help? Contact us at support@recapply.com
//           </p>
//         </div>
//       </div>
//     </body>
...
//         </div>
//         <div class="content">
//           <h2 style="color: #ff6b6b; text-align: center;">Hello ${name}!</h2>
//           <p style="text-align: center; color: #666;">We received a request to reset your password. Don't worry, it happens to the best of us!</p>
          
//           <div class="reset-box">
//             <p style="font-size: 18px; margin-bottom: 25px;">Click the button below to reset your password:</p>
//             <a href="${resetUrl}" class="reset-button">🔄 Reset Password</a>
//           </div>
          
//           <div class="warning-box">
//             <h3 style="color: #856404; margin-bottom: 10px;">⚠️ Important Security Information</h3>
...
//             <span style="color: #ff6b6b;">${resetUrl}</span>
//           </p>
//         </div>
...
//             © ${new Date().getFullYear()} ${process.env.COMPANY_NAME || 'Rec Apply'}
//           </p>
//         </div>
//       </div>
//     </body>
...
// const getPasswordChangedEmailTemplate = (name) => {
//   return `
//     <!DOCTYPE html>
//     <html>
//     <head>
...
//           <h2 style="color: #00b09b;">Hello ${name}!</h2>
//           <p style="font-size: 18px; color: #666; margin: 20px 0;">Your password has been successfully changed.</p>
          
//           <div class="security-tips">
//             <h3 style="color: #00b09b; margin-bottom: 15px;">🛡️ Security Tips:</h3>
//             <ul style="color: #666;">
...
//             isVerified: false
//           },
//           warning: 'Email verification was skipped due to email service issues'
//         });
//       }
...
//     const emailSent = await sendEmailWithRetry({
//       to: user.email,
//       subject: `✨ Welcome to ${process.env.COMPANY_NAME || 'Rec Apply'}! Verify Your Email`,
...
//             isVerified: false
//           },
//           warning: 'Email verification failed. User was still created for development.'
//         });
//       }
...
//         await sendEmailWithRetry({
//           to: user.email,
//           subject: `✨ Verify Your Updated Email - ${process.env.COMPANY_NAME || 'Rec Apply'}`,
//           html: getVerificationEmailTemplate(user.name, verificationUrl)
//         });
//       }
//     }
...
//       await sendEmailWithRetry({
//         to: user.email,
//         subject: `🔒 Password Changed Successfully - ${process.env.COMPANY_NAME || 'Rec Apply'}`,
...
//       await sendEmailWithRetry({
//         to: user.email,
//         subject: `🔒 Password Reset Successful - ${process.env.COMPANY_NAME || 'Rec Apply'}`,
//         html: getPasswordChangedEmailTemplate(user.name)
//       });
//     }
...
//       await sendEmailWithRetry({
//         to: user.email,
//         subject: `🎉 Welcome to ${process.env.COMPANY_NAME || 'Rec Apply'}! Email Verified`,
...
//     const emailSent = await sendEmailWithRetry({
//       to: user.email,
//       subject: `🔑 Password Reset Request - ${process.env.COMPANY_NAME || 'Rec Apply'}`,
...
//       await sendEmailWithRetry({
//         to: user.email,
//         subject: `Account Deletion Confirmation - ${process.env.COMPANY_NAME || 'Rec Apply'}`,
//         html: `
//           <!DOCTYPE html>
//           <html>
//           <head>
...
//               <div class="content">
//                 <h2>Hello ${user.name},</h2>
//                 <p class="message">Your account has been successfully deleted from ${process.env.COMPANY_NAME || 'Rec Apply'}.</p>
...
// //       await sendEmailWithRetry({
// //         to: user.email,
// //         subject: `Account Deleted by Administrator - ${process.env.COMPANY_NAME || 'Rec Apply'}`,
// //         html: `
// //           <!DOCTYPE html>
// //           <html>
// //           <head>
...
//     // 🚫 Block deleting this specific email
//     if (user.email === "akingeneyeleon@gmail.com") {
//       incrementCounter('crud', 'delete', 'failed', 1);
...
// // Create reusable transporter - FIXED VERSION
// const createTransporter = () => {
//   // Clean the SMTP password - remove any spaces and ensure it's a string
//   const smtpPass = process.env.SMTP_PASS ? process.env.SMTP_PASS.toString().replace(/\s+/g, '').trim() : '';
//   const port = parseInt(process.env.SMTP_PORT) || 587;

//   // Log email configuration for debugging (without exposing full password)
...
//     logger: true // Enable logger to see errors
//   });
// };

// // Send email function - FIXED VERSION with better error handling and NO SKIP
// const sendEmail = async ({ to, subject, html }) => {
//   try {
...
//       console.error('❌ SMTP Error Command:', verifyError.command);
//       if (verifyError.code === 'EAUTH') {
//         console.error('❌ Authentication failed - Check your Gmail App Password');
//         console.error('❌ Make sure 2FA is enabled and you are using an App Password, not your regular Gmail password');
//       }
//       throw verifyError;
//     }
...
// // Helper function to check email service health - FIXED VERSION
// async function checkEmailServiceHealth() {
//   const startTime = Date.now();
//   incrementCounter('system', null, 'emailServiceChecks');
...
//       return true;
//     } catch (verifyError) {
//       console.error('❌ Email service health check failed:', verifyError.message);
//       incrementCounter('system', 'errors', 'total', 1, { 
//         error: verifyError,
//         endpoint: 'checkEmailServiceHealth'
//       });
...
// // Helper function for email sending with retry - REMOVED SKIP EMAIL LOGIC
// async function sendEmailWithRetry(emailData, maxRetries = 3) {
//   incrementCounter('email', 'total', null, 1);
...
//     if (!emailSent) {
//       // In production, we should handle this carefully
//       console.error('❌ Email sending failed for user:', email);
      
//       // Don't delete user in development, but in production we might want to
//       if (process.env.NODE_ENV === 'production') {
//         // Option: Delete user if email fails in production
//         // await User.findByIdAndDelete(user._id);
//         console.log('⚠️ User created but verification email failed');
//       }
...
//     res.status(201).json({
//       message: emailSent ? 'User registered successfully. Please verify your email.' : 'User registered successfully but verification email failed to send. Please contact support.',
//       token,
//       user: {
//         id: user._id,
//         name: user.name,
...
const createTransporter = () => {
  ...
  return nodemailer.createTransport({
    ...
    auth: {
      user: process.env.SMTP_USER,
      pass: smtpPass, // This should be your Gmail App Password (16 chars, no spaces)
    },
    tls: {
      rejectUnauthorized: false, // Only for development
    },
...
// Send email function - FIXED VERSION with better error handling
const sendEmail = async ({ to, subject, html }) => {
  try {
    console.log(`📧 Preparing to send email to: ${to}`);
    console.log(`📧 Subject: ${subject}`);
    ...
    try {
      ...
      if (verifyError.code === 'EAUTH') {
        console.error('❌ Authentication failed - Check your Gmail App Password');
        console.error('❌ Make sure 2FA is enabled and you are using an App Password, not your regular Gmail password');
        console.error('❌ Current password format length:', process.env.SMTP_PASS ? process.env.SMTP_PASS.length : 0);
      }
      throw verifyError;
    }
...
// Helper function to check email service health - SIMPLIFIED VERSION
async function checkEmailServiceHealth() {
  const startTime = Date.now();
  incrementCounter('system', null, 'emailServiceChecks');
...
// Helper function for email sending with retry - SIMPLIFIED
async function sendEmailWithRetry(emailData, maxRetries = 3) {
  incrementCounter('email', 'total', null, 1);
...
exports.register = async (req, res) => {
  ...
  try {
    ...
    if (emailSent) {
      ...
      console.log(`⚠️ Verification email could not be sent to ${email} - user can request resend later`);
    }
    ...
    res.status(201).json({
      ...
      emailStatus: emailSent ? 'sent' : 'failed',
      verificationUrl: emailSent ? undefined : verificationUrl // Only send URL in response if email failed
    });
  } catch (error) {
    console.error('❌ Registration error:', error);
  ...
  try {
    ...
    if (email && email !== user.email) {
      ...
      try {
        ...
        console.error('Failed to send verification email after email update:', emailError.message);
      }
    }
...
exports.verifyEmail = async (req, res) => {
  ...
  try {
    ...
    if (error.name === 'JsonWebTokenError' || error.name === 'TokenExpiredError') {
      return res.redirect(`${process.env.FRONTEND_URL}/verification-failed?reason=invalid-token`);
    }
    
    res.redirect(`${process.env.FRONTEND_URL}/verification-failed?reason=server-error`);
  }
};
...
exports.resendVerificationEmail = async (req, res) => {
  ...
  try {
    ...
    const emailSent = await sendEmailWithRetry({
      to: user.email,
      subject: `✨ Verify Your Email - ${process.env.COMPANY_NAME || 'Rec Apply'}`,
      html: getVerificationEmailTemplate(user.name, verificationUrl)
    });
...
exports.deleteAccount = async (req, res) => {
  ...
  try {
    ...
    try {
      ...
      console.error('Failed to send deletion notification:', emailError.message);
    }
  ...
  try {
    ...
    for (const user of users) {
      try {
        ...
        console.error(`Failed to send deletion notification to ${user.email}:`, emailError.message);
      }
    }
...
exports.checkSystemHealth = async (req, res) => {
  ...
  try {
    ...
    try {
      ...
      if (!isEmailHealthy) {
        health.status = 'degraded';
        health.emailMessage = 'Email service is unavailable. Verification emails may not be sent.';
      }
    } catch (emailError) {
      health.services.email = 'unhealthy';
      health.status = 'degraded';
