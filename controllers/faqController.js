...
//     console.log('🔍 getAllQuestions called with query:', req.query);
...
//     // Count all documents first (no filter)
//     const totalCount = await Question.countDocuments({});
//     console.log('📊 Total questions in DB:', totalCount);
    
//     // Get all questions without any filter to debug
//     const allQuestions = await Question.find({}).limit(5).lean();
//     console.log('📊 First 5 questions in DB:', allQuestions);
