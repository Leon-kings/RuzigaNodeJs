...
const bookingSchema = new mongoose.Schema({
  university: { 
    type: mongoose.Schema.Types.ObjectId, 
    ref: 'University',  // This enables populate()
    required: [true, 'University is required'] 
  },
  universityName: { type: String, required: true }, // Optional, for convenience
  student: {
    fullName: { type: String, required: [true, 'Full name is required'] },
    email: { type: String, required: [true, 'Email is required'], lowercase: true, trim: true },
    phone: { type: String, required: [true, 'Phone number is required'] },
    country: { type: String, required: [true, 'Country is required'] },
    programInterest: { type: String, required: [true, 'Program interest is required'] },
    intakeYear: { type: String, required: [true, 'Intake year is required'] },
  },
  bookingDetails: {
...
// ================= Middleware =================
universitySchema.pre('save', function() { this.updatedAt = Date.now(); });
bookingSchema.pre('save', function() { this.updatedAt = Date.now(); });
